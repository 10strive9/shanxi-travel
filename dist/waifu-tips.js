...
function playVoice(text) {
    ...
    // 优先使用中文语音包
    const chineseVoices = window.speechSynthesis.getVoices().filter(voice => 
...
class c {
            ...
            try {
                ...
                if (2 === o) {
                    ...
                    (this.cubism5model = new t()),
                        ...
                        2 !== this.currentModelVersion && this.cubism5model.subdelegates.at(0) ? this.cubism5model.changeModel(e) : (this.cubism5model.initialize(), this.cubism5model.changeModel(e), this.cubism5model.run());
                }
    ...
    async loadNextModel() {
        (this.modelTexturesId = 0),
            this.useCDN
                ? ((this.modelId = (this.modelId + 1) % this.modelList.models.length), await this.loadModel(this.modelList.messages[this.modelId]))
                : ((this.modelId = (this.modelId + 1) % this.models.length), await this.loadModel(this.models[this.modelId].message));
    }
}
class d {
    constructor(e, t, s) {
            ...
            (this.tools = {
                ...
                "toggle-voice": {
                    icon: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">\
                        <path d="M320 32c-53 0-96 43-96 96v64c-70.7 0-128 57.3-128 128s57.3 128 128 128v64c0 53 43 96 96 96s96-43 96-96V320c35.3 0 64-28.7 64-64s-28.7-64-64-64V128c0-53-43-96-96-96zm-16 352c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32zm32-160c0 17.7-14.3 32-32 32s-32-14.3-32-32 14.3-32 32-32 32 14.3 32 32zm-32-192c17.7 0 32 14.3 32 32s-14.3 32-32 32-32-14.3-32-32 14.3-32 32-32z"/>\
                        </svg>',
                    callback: () => {
                        const isEnabled = localStorage.getItem('voice-enabled') !== 'false';
                        if (isEnabled) {
...
async function r(t) {
    ...
    localStorage.removeItem("waifu-display"),
        sessionStorage.removeItem("waifu-message-priority"),
        // 初始化语音开关状态（默认开启）
        localStorage.getItem('voice-enabled') === null && localStorage.setItem('voice-enabled', 'true'),
            ...
            (function (t) {
                ...
                t.seasons.forEach(({ date: t, text: s }) => {
                    ...
                    window.addEventListener("click", (s) => {
                        var o;
                        for (let { selector: n, text: l } of t.click) if (null === (o = s.target) || void 0 === o ? void 0 : o.closest(n)) return (l = e(l)), (l = l.replace("{text}", s.target.innerText)), void i(l, 4e3, 8);
                    }),
...
window.initWidget = function (e) {
    ...
    null == t ||
        ...
        localStorage.getItem("waifu-display") && Date.now() - Number(localStorage.getItem("waifu-display")) <= 864e5
